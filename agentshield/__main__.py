...
Usage:
    python -m AgentShield setup
    AgentShield setup --path ./my-policy.yaml
"""
...
@click.group()
def cli():
    """AgentShield CLI - Advanced policy enforcement for AI agents"""
    pass


def _create_setup_readme(project_path: Path):
    """Create a SETUP.md file with integration instructions"""
    readme_content = """# AgentShield Setup Guide
...
- Documentation: https://github.com/yourusername/AgentShield
- Issues: https://github.com/yourusername/AgentShield/issues
- Examples: See `examples/` directory

## Security

AgentShield provides multiple layers of protection:
...
"""
    ...
    readme_path = project_path / "AgentShield_SETUP.md"
...
def setup(path: str):
    ...
    # Interactive setup
    click.echo("\n" + "="*60)
    click.echo("AgentShield Setup Wizard")
    click.echo("="*60 + "\n")
    ...
    if project_type.lower() == "new":
        ...
        # Copy example files from AgentShield package
    ...
    if project_type.lower() == "new":
        ...
        click.echo(f"  • AgentShield_SETUP.md")
        click.echo("\nNext steps:")
