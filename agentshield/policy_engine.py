...
from .simulator import simulate_swap
from .rules import (
    ValidationResult,
...
class PolicyConfig:
    ...
    def create_default(cls, output_path: str | Path):
        ...
        default_config = {
            ...
            # GLOBAL MASTER SWITCH: Set to false to disable ALL AgentShield checks
            "enabled": True,
...
class PolicyEngine:
    ...
    def __init__(
        ...
        # self.simulator = TransactionSimulator(web3_provider)  # Not implemented yet
        self.simulator = None  # Simulation disabled for now
    ...
    def validate_transaction(self, transaction: Dict[str, Any], from_address: Optional[str] = None) -> tuple[bool, str]:
        ...
        elif self.config.simulation.get("enabled", False) and from_address and self.simulator:
