...
The honeypot token contract implements 7 real-world scam techniques to test AgentShield's protection capabilities. The agent now has special actions to interact with this honeypot and demonstrate PolicyLayer's honeypot detection.
...
| # | Technique | What It Does | How AgentShield Detects |
|---|-----------|-------------|----------------------|
